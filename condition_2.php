...
<body>
    ...
    <div class="alert alert-info">
        ...
        <p>To help you revise your design, we have collected feedback from three independent reviewers on your initial design. Please review each piece of the feedback and rate its quality. You may want to consider the degree to which the feedback is helpful for improving the design or gaining insight. Also, you may disregard any feedback that is outside the scope of the design brief.
...
function onClickSubmit(buttonNum) {
    if(buttonNum == "1") {
        ...
        window.location.href = "paraphrasing.php";
    }
}
