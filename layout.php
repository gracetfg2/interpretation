...
<div id='survey-part' style="display:none">
	...
	<p><br>You can click on the image to enlarge.</p></span>
			...
			<div class="row">	
				...
				<div class="sub_frame">	
					<div id="fbk_div">
					<h4 class="question-text required"><strong>2. Enter your feedback about the <span style="color:blue"><em>layout and composition </em> </span>of the design, including both its strengths and weaknesses. &nbsp</strong><em style="color:red;"> (required)</em></h4>
