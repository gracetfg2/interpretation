...
<body>
    ...
    <div class="alert alert-info">
       ...
       <h3>Review Feedback</h3>
        <p>To help you revise your design, we have collected feedback from three independent reviewers on your initial design. For each feedback, we want you to review the content, reflect on it, and rate its quality. 
      
        For the ratings, you may want to consider the degree to which the feedback is helpful for improving the design or gaining insight. Also, you may disregard any feedback that is outside the scope of the design brief.</p> 

        <p>You should spend about<strong> 5 minutes reviewing each feedback. </strong> You will need to complete the feedback tasks before reviewing the next one. After reviewing all the feedback, please click "Submit" to save your responses and go to the next step. 
        </p>
    ...
    <div class="row" id="task">
            <div class='panel-body'>
                ...
                <td style='text-align: justify; padding-bottom:10px; padding-right:25px;' class='table-text'>
                    ...
                    <hr>
                    <p><strong>What do I feel about the feedback</strong></p>
                    <textarea rows="3"></textarea>

                     <p><strong>What do I think about the feedback</strong></p>
                 <textarea rows="3"></textarea>

                     <p><strong>Based on the feedback, what actions could I take to improve my design?</strong></p>
                    <textarea rows="3"></textarea>
                    <br><br><button type="button" class="btn btn-info" onclick="onClickSubmit(1);">Save and Review the Next</button>
                ...
                <td style='text-align: justify; padding-bottom:10px; padding-right:25px;' class='table-text'>
                   ...
                   <p><strong>What do I feel about the feedback</strong></p>
                    ...
                    <textarea></textarea>
                     ...
                     <p><strong>Based on the feedback, what actions could I take to improve my design?</strong></p>
                    <textarea></textarea>
                   <br><br><button type="button" class="btn btn-info" onclick="onClickSubmit(2);">Save and Review the Next</button>
