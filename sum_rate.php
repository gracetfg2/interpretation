...
<body>
  <?php include('webpage-utility/ele_nav.php');?>
    ...
    <div class="alert alert-info" id="instruction">
       ...
       <h3>Rate Feedback</h3>
          <p>Please rate each piece of the feedback. You may want to consider the degree to which the feedback is helpful for improving the design or gaining insight. Also, you may disregard any feedback that is outside the scope of the design brief.</li>
        </p>
        <hr>
