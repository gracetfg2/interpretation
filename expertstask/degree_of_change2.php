...
<span>For each design project, you need to answer four questions. The first question asks you to select which design better addresses the design brief. The remaining three questions will ask you to rate the degree of change between the two iterations in terms of three aspects.
