  ...
  <?php 
		...
		foreach($projects as $value)
		{
		    ...
		    //Display
		     ...
		     echo "
		     	<div class='well' >
					<span>we had 105 participants generate an initial and revised design for the following design brief. We need your help evaluating the degree of revision and selecting which design better meets the design goals stated in the brief. On this interface, you can navigate through all the design projects using the indicators on the bottom of the page. Or the interface will automatically direct you to the next project once you finish ratings for the current one. For each design project, you will be presented with both the initial and revised design. The order of the iteration presented is randomized. The total rating time should be about 45 minutes.</span> <br>
