    ...
    <!--<div class="alert alert-info">
        ...
        <div id="task">
            ...
            <div style="display:none;" id="p1">
                ...
                <hr>
                 <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp  Please restate the meaning of feedback #1 using your own words:</h5><textarea id="monitoredtext" monitorid="0" rows="4"></textarea>
            ...
            <div style="display:none;" id="p2">
                ...
                <hr>
                 <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp Please restate the meaning of feedback #2 using your own words:</h5><textarea id="monitoredtext" monitorid="1" rows="4"></textarea>
            ...
            <div style="display:none" id="p3">
                ...
                <hr>
                <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp Please restate the meaning of feedback #3 using your own words:</h5><textarea id="monitoredtext" monitorid="2" rows="4"></textarea>
            ...
            <button type="button" class="btn btn-default" onclick="printJSON();" id="debugJSON">Submit Behavior to Database
