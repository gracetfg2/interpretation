    ...
    <div class="container">
        ...
        <div class="alert alert-info" id="instruction">
            <h3>Review Feedback</h3>
               <p>We have collected feedback from three independent reviewers to help you revise your design. We want you to review all the feedback and use your own words to restate its meaning. You might imagine explaning this set of feedback to your co-workers. After that, please click "Next" to go to the next step. </p>
               <br>
