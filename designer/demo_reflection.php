...
<p style="font-size:22px"> Before revising your design, we want you to consider the design choices you made and plan how you are going to revise the design by responding to three questions. Imagine that your flyer has been posted on a bulletin board in any public space. Please spend around <strong>15 minutes </strong>thinking and answering all the questions. After that, please click SUBMIT to continue to the next step.
	<p><br>
...
<div class="col-md-12">
 ...
 &nbsp</strong><em style="color:red;"></em></h4>
		 <textarea id="designconcept" name="designconcept" rows="3" cols="62" onkeyup="onTextKeyUp(this.id)" onkeydown="onTextKeyDown(this.id,event)" style="width:100%;"><?php echo htmlspecialchars($designconcept); ?></textarea>
	...
	<div class="sub_frame required" id="div-good">				
		<h4 class="question-text"><strong>2. What do you think was done particularly well in your initial design?&nbsp Please explain why.</strong><em style="color:red;"> (required)</em></h4>
		 <textarea id="good" name="good" rows="3" cols="62" onkeyup="onTextKeyUp(this.id)" onkeydown="onTextKeyDown(this.id,event)" style="width:100%;"><?php echo htmlspecialchars($good); ?></textarea>	
	...
	<div class="sub_frame required" id="div-bad">				
		<h4 class="question-text"><strong>3. What could be the weakness of your initial design? And in what ways do you think the initial design can be improved? &nbsp</strong><em style="color:red;"> (required)</em></h4>
		 <textarea id="bad" name="bad" rows="3" cols="62" onkeyup="onTextKeyUp(this.id)" onkeydown="onTextKeyDown(this.id,event)" style="width:100%;"><?php echo htmlspecialchars($bad); ?></textarea>	
	...
	<div style='text-align:center ;margin-top:20px;margin-bottom:20px'>
		 <button type='submit' class='btn-submit' id='submit-bn' style="font-size:22px" onclick='submit();'>Submit</button> 
	</div>
