    ...
    <div class="container" style="line-height: 1.5em;">
        ...
        <div class="alert alert-info" id="instruction">
            <h3>Review Feedback</h3>
             <p>We have collected feedback from two independent reviewers to help you revise your design. Each reviewer has at least three years of professional experience in design. Please review the feedback carefully and answer three reflection questions.</p>
            <br>
            <p style="font-size:16px">
    <a href= 'vew_feedback.php?mid=<?php echo $mid;?>' target="_blank"> See my initial design and feedback</a>
    </p>
...
<div id='task'>
            ...
            if(count($feedback)<1){
                ...
                echo " <thead><tr>
                <td width='5%'></td>
                <td width='60%' align='left'><strong>Feedback Content</strong></td>
                </tr></thead> <tbody>";
