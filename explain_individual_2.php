    ...
    <div class="container">
        ...
        <div class="alert alert-info" id="instruction">
            <h3>Review Feedback</h3>
               <p>We have collected feedback from three independent reviewers to help you revise your design. The first piece of feedback is shown below. For each piece of feedback, we want you to use your own words to restate its meaning and then rate its usefulness. You may want to imagine explaning that feedback to your co-workers. The writing and rating task will be repeated for each of the three pieces of feedback.</p>
               <br>
    ...
    <!--<div class="alert alert-info">
        ...
        <div id="task">
            ...
            <div style="display:none;" id="p1">
                ...
                <hr>
                 <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp  Please use your own words to restate the meaning of feedback #1:</h5><textarea rows="4"></textarea>
            </div>
            ...
            <div style="display:none;" id="p3">
                ...
                <hr>
                 <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp Please use your own words to restate the meaning of feedback #2:</h5><textarea rows="4"></textarea>
            </div>
            ...
            <div style="display:none" id="p5">
                ...
                <hr>
                <h5><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp Please use your own words to restate the meaning of feedback #3: </h5><textarea rows="4"></textarea>
            </div>
